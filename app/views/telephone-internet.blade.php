...
@stop
    ...
    <div class="row">
        ...
        <form id="telephone-internet" role="form" method="post" enctype="multipart/form-data" action={{{action('Reimbursement@submitTelephoneInternet')}}}>
        ...
        <select id="monthSelect" class="form-control" placeholder="Mode" name="monthSelect">
          ...
          <div class="row"><div class="form-group col-md-4 col-md-offset-4 col-sm-12">
              ...
              <textarea class="form-control" name="comments" placeholder="Comments" form="telephone-internet"></textarea>
          </div></div>
       <div class="row">   <div class="form-group col-md-4 col-md-offset-4 col-sm-12">
          ...
          <div class="row"><div class="form-group col-md-4 col-md-offset-4 col-sm-12"><button type="submit" class="btn btn-default">Submit</button></div></div>
    </form>
    </div>
    </div>
